...
enum opt_code
{
  ...
  OPT_mapcs = 1679,                          /* -mapcs */
  OPT_mapcs_frame = 1680,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1681,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1682,              /* -mapcs-stack-check */
  OPT_march_ = 1683,                         /* -march= */
  OPT_marm = 1684,                           /* -marm */
  OPT_masm_syntax_unified = 1685,            /* -masm-syntax-unified */
  OPT_mbe32 = 1686,                          /* -mbe32 */
  OPT_mbe8 = 1687,                           /* -mbe8 */
  OPT_mbig_endian = 1688,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1689,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1690,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1691,     /* -mcaller-super-interworking */
  OPT_mcmse = 1692,                          /* -mcmse */
  OPT_mcpu_ = 1693,                          /* -mcpu= */
  OPT_mfdpic = 1694,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1695,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1696,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1697,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1698,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1699,                  /* -mfp16-format= */
  OPT_mfpu_ = 1700,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1701,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1702, */              /* -mhard-float */
  OPT_mlibarch_ = 1703,                      /* -mlibarch= */
  OPT_mlittle_endian = 1704,                 /* -mlittle-endian */
  OPT_mlong_calls = 1705,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1706,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1707,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1708,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1709,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1710,               /* -mprint-tune-info */
  OPT_mpure_code = 1711,                     /* -mpure-code */
  OPT_mrestrict_it = 1712,                   /* -mrestrict-it */
  OPT_msched_prolog = 1713,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1714,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1715,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1716, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1717,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1718,                         /* -mthumb */
  OPT_mthumb_interwork = 1719,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1720,                  /* -mtls-dialect= */
  OPT_mtp_ = 1721,                           /* -mtp= */
  OPT_mtpcs_frame = 1722,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1723,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1724,                         /* -mtune= */
  OPT_munaligned_access = 1725,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1726,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1727,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1728,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1729,              /* -mword-relocations */
  OPT_n = 1730,                              /* -n */
  ...
  OPT_quiet = 1764,                          /* -quiet */
  OPT_r = 1765,                              /* -r */
  OPT_remap = 1766,                          /* -remap */
  OPT_reverse_sort = 1767,                   /* -reverse-sort */
  OPT_s = 1768,                              /* -s */
  OPT_save_temps = 1769,                     /* -save-temps */
  OPT_save_temps_ = 1770,                    /* -save-temps= */
  OPT_shared = 1771,                         /* -shared */
  OPT_shared_libgcc = 1772,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1773,               /* -shared-libphobos */
  OPT_size_sort = 1774,                      /* -size-sort */
  /* OPT_specs = 1775, */                    /* -specs */
  OPT_specs_ = 1776,                         /* -specs= */
  OPT_static = 1777,                         /* -static */
  OPT_static_libasan = 1778,                 /* -static-libasan */
  OPT_static_libgcc = 1779,                  /* -static-libgcc */
  OPT_static_libgfortran = 1780,             /* -static-libgfortran */
  OPT_static_libgo = 1781,                   /* -static-libgo */
  OPT_static_libhwasan = 1782,               /* -static-libhwasan */
  OPT_static_liblsan = 1783,                 /* -static-liblsan */
  OPT_static_libmpx = 1784,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1785,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1786,               /* -static-libphobos */
  OPT_static_libstdc__ = 1787,               /* -static-libstdc++ */
  OPT_static_libtsan = 1788,                 /* -static-libtsan */
  OPT_static_libubsan = 1789,                /* -static-libubsan */
  OPT_static_pie = 1790,                     /* -static-pie */
  /* OPT_std_c__03 = 1791, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1792, */                /* -std=c++0x */
  OPT_std_c__11 = 1793,                      /* -std=c++11 */
  OPT_std_c__14 = 1794,                      /* -std=c++14 */
  OPT_std_c__17 = 1795,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1796, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1797, */                /* -std=c++1z */
  OPT_std_c__20 = 1798,                      /* -std=c++20 */
  OPT_std_c__23 = 1799,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1800, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1801, */                /* -std=c++2b */
  OPT_std_c__98 = 1802,                      /* -std=c++98 */
  OPT_std_c11 = 1803,                        /* -std=c11 */
  OPT_std_c17 = 1804,                        /* -std=c17 */
  /* OPT_std_c18 = 1805, */                  /* -std=c18 */
  /* OPT_std_c1x = 1806, */                  /* -std=c1x */
  OPT_std_c2x = 1807,                        /* -std=c2x */
  /* OPT_std_c89 = 1808, */                  /* -std=c89 */
  OPT_std_c90 = 1809,                        /* -std=c90 */
  OPT_std_c99 = 1810,                        /* -std=c99 */
  /* OPT_std_c9x = 1811, */                  /* -std=c9x */
  OPT_std_f2003 = 1812,                      /* -std=f2003 */
  OPT_std_f2008 = 1813,                      /* -std=f2008 */
  OPT_std_f2008ts = 1814,                    /* -std=f2008ts */
  OPT_std_f2018 = 1815,                      /* -std=f2018 */
  OPT_std_f95 = 1816,                        /* -std=f95 */
  OPT_std_gnu = 1817,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1818, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1819, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1820,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1821,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1822,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1823, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1824, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1825,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1826,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1827, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1828, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1829,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1830,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1831,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1832, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1833, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1834,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1835, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1836,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1837,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1838, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1839, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1840,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1841, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1842, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1843, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1844, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1845, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1846,                     /* -std=legacy */
  OPT_stdlib_ = 1847,                        /* -stdlib= */
  OPT_symbol_ = 1848,                        /* -symbol= */
  OPT_symbolic = 1849,                       /* -symbolic */
  OPT_t = 1850,                              /* -t */
  OPT_time = 1851,                           /* -time */
  OPT_time_ = 1852,                          /* -time= */
  OPT_traditional = 1853,                    /* -traditional */
  OPT_traditional_cpp = 1854,                /* -traditional-cpp */
  OPT_tree_stats = 1855,                     /* -tree-stats */
  OPT_trigraphs = 1856,                      /* -trigraphs */
  OPT_type_stats = 1857,                     /* -type-stats */
  OPT_u = 1858,                              /* -u */
  OPT_undef = 1859,                          /* -undef */
  OPT_v = 1860,                              /* -v */
  OPT_version = 1861,                        /* -version */
  OPT_w = 1862,                              /* -w */
  OPT_wrapper = 1863,                        /* -wrapper */
  OPT_x = 1864,                              /* -x */
  OPT_z = 1865,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
