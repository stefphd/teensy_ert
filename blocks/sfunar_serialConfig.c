 ...
 *
 *   ABSTRACT:
 *     The purpose of this SFunction is to call a function during simulation:
 *
 *        serialConfigOutput()
 */
 ...
 */
#define S_FUNCTION_NAME                sfunar_serialConfig
...
static void mdlCheckParameters(SimStruct *S)
{
  ...
  if EDIT_OK(S, 1) {
    ...
    /* Check the parameter attributes */
    ssCheckSFcnParamValueAttribs(S, 0, "P2", DYNAMICALLY_TYPED, 2, dimsArray, 0);
  }
}
