 ...
 */
#define S_FUNCTION_NAME                sfunar_encoder
...
#define PINA            (ssGetSFcnParam(S,0))
#define PINB            (ssGetSFcnParam(S,1))
#define ENPINB          (ssGetSFcnParam(S,2))
#define PINMODE         (ssGetSFcnParam(S,3))
#define MODE            (ssGetSFcnParam(S,4))
#define RESET           (ssGetSFcnParam(S,5))
...
static void mdlRTW(SimStruct *S)
{
    ...
    int32_T enpinb = (int32_T) mxGetPr(ENPINB)[0];
    int32_T reset = (int32_T) mxGetPr(RESET)[0];

    if (!ssWriteRTWParamSettings(S, 6,
                    SSWRITE_VALUE_DTYPE_NUM,  "PinA",       &pina, DTINFO(SS_INT32, COMPLEX_NO),
                    SSWRITE_VALUE_DTYPE_NUM,  "PinB",       &pinb, DTINFO(SS_INT32, COMPLEX_NO),
                    SSWRITE_VALUE_DTYPE_NUM,  "EnableB",    &enpinb, DTINFO(SS_INT32, COMPLEX_NO),
                    SSWRITE_VALUE_STR,        "Pinmode",    mxArrayToString(PINMODE),
                    SSWRITE_VALUE_STR,        "Mode",       mxArrayToString(MODE),
                    SSWRITE_VALUE_DTYPE_NUM,  "Reset",      &reset, DTINFO(SS_INT32, COMPLEX_NO)                              
                    ))
    {
