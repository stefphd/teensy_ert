...
/*
 *   sfunar_WireWrite.c Simple C-MEX S-function for function call.
 *
 */
 ...
 */
#define S_FUNCTION_NAME                sfunar_WireWrite
...
#define ADDRESS                        (ssGetSFcnParam(S, 1))
...
static void mdlInitializeSizes(SimStruct *S)
{
   ...
   */
  ssSetInputPortDataType(S, 0, DYNAMICALLY_TYPED); //SS_UINT8
