/*
 *   sfunar_overrunCounter.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this SFunction is to get number of overruns
 *
 */
 ...
 */
#define S_FUNCTION_NAME                sfunar_overrunCounter
